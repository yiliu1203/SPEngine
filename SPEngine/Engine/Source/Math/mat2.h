...
#ifndef SP_MATH_MAT2_H
#define SP_MATH_MAT2_H
...
namespace std {
template <typename T>
constexpr void swap(SP::math::details::TMat22<T>& lhs, SP::math::details::TMat22<T>& rhs) noexcept
{
