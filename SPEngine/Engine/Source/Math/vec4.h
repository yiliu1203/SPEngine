...
#ifndef SP_MATH_VEC4_H
#define SP_MATH_VEC4_H
...
using _vec4 = details::TVec4<T>;

using _double4 = _vec4<double>;
using _float4  = _vec4<float>;
using _half4   = _vec4<half>;
using _int4    = _vec4<int32_t>;
using _uint4   = _vec4<uint32_t>;
using _short4  = _vec4<int16_t>;
using _ushort4 = _vec4<uint16_t>;
using _byte4   = _vec4<int8_t>;
using _ubyte4  = _vec4<uint8_t>;
using _bool4   = _vec4<bool>;
