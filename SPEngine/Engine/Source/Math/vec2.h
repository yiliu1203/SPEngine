...
#ifndef SP_MATH_VEC2_H
#define SP_MATH_VEC2_H
...
public:
    ...
    template <typename U>
    friend inline constexpr arithmetic_result_t<T, U> cross(const TVec2& u, const TVec2<U>& v) noexcept
    {
...
// template <typename T>
// requires details::C_Arithmetic<T>
