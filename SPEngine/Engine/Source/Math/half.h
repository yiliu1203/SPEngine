...
#ifndef SP_MATH_HALF_H
#define SP_MATH_HALF_H
...
class fp
{
    ...
    struct fp32
    {
        ...
        explicit constexpr fp32(uint32_t b) noexcept
            : bits(b)
        {}   // NOLINT
        constexpr void         setS(unsigned int s) noexcept { bits = uint32_t((bits & 0x7FFFFFFFu) | (s << 31u)); }
...
template <>
struct is_arithmetic<SP::math::half> : public std::true_type
{};
...
template <>
struct is_floating_point<SP::math::half> : public std::true_type
{};
...
template <>
class numeric_limits<SP::math::half>
{
public:
    typedef SP::math::half type;
    ...
    inline static constexpr type round_error() noexcept { return SP::math::makeHalf(0x3800); }
    inline static constexpr type min() noexcept { return SP::math::makeHalf(0x0400); }
    inline static constexpr type max() noexcept { return SP::math::makeHalf(0x7bff); }
    inline static constexpr type lowest() noexcept { return SP::math::makeHalf(0xfbff); }
    inline static constexpr type epsilon() noexcept { return SP::math::makeHalf(0x1400); }
    inline static constexpr type infinity() noexcept { return SP::math::makeHalf(0x7c00); }
    inline static constexpr type quiet_NaN() noexcept { return SP::math::makeHalf(0x7fff); }
    inline static constexpr type denorm_min() noexcept { return SP::math::makeHalf(0x0001); }
    inline static constexpr type signaling_NaN() noexcept { return SP::math::makeHalf(0x7dff); }
};

}   // namespace std

#endif   // SP_MATH_HALF_H
