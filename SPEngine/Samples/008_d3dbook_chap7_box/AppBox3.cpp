...
class BoxApp3 : public D3DApp
{
public:
    BoxApp3(HINSTANCE hInstance);
    BoxApp3(const BoxApp3& rhs)            = delete;
    BoxApp3& operator=(const BoxApp3& rhs) = delete;
    ~BoxApp3();
...
BoxApp3::BoxApp3(HINSTANCE hInstance)
    : D3DApp(hInstance)
{}

BoxApp3::~BoxApp3() {}

bool BoxApp3::Initialize()
{
...
void BoxApp3::Update(const GameTimer& gt)
{
...
void BoxApp3::Draw(const GameTimer& gt)
{
...
void BoxApp3::OnMouseDown(WPARAM btnState, int x, int y)
{
    mLastMousePos.x = x;
    mLastMousePos.y = y;
...
void BoxApp3::OnMouseUp(WPARAM btnState, int x, int y)
{
    ReleaseCapture();
}

void BoxApp3::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void BoxApp3::BuildDescriptorHeaps()
{
...
void BoxApp3::BuildConstantBuffers()
{
...
void BoxApp3::BuildRootSignature()
{
...
void BoxApp3::BuildShadersAndInputLayout()
{
    HRESULT hr = S_OK;
