...
class BoxApp2 : public D3DApp
{
public:
    BoxApp2(HINSTANCE hInstance);
    BoxApp2(const BoxApp2& rhs)            = delete;
    BoxApp2& operator=(const BoxApp2& rhs) = delete;
    ~BoxApp2();
...
BoxApp2::BoxApp2(HINSTANCE hInstance)
    : D3DApp(hInstance)
{}

BoxApp2::~BoxApp2() {}

bool BoxApp2::Initialize()
{
...
void BoxApp2::Update(const GameTimer& gt)
{
...
void BoxApp2::BuildShadersAndInputLayout()
{
    HRESULT hr = S_OK;
