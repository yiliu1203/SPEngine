...
#ifndef SP_MATH_QUAT_H
#define SP_MATH_QUAT_H
...
public:
    ...
    // Handles implicit conversion to a quatd. Must not be explicit.
    template <typename A, typename = enable_if_arithmetic_t<A>>
    constexpr TQuaternion(A w)
        : x(0)
        , y(0)
        , z(0)
        , w(w)
...
constexpr inline quatd operator""_i(long double v)
{
    return {0.0, double(v), 0.0, 0.0};
}

constexpr inline quatd operator""_j(long double v)
{
    return {0.0, 0.0, double(v), 0.0};
}

constexpr inline quatd operator""_k(long double v)
{
    return {0.0, 0.0, 0.0, double(v)};
}

constexpr inline quatd operator""_i(unsigned long long v)
{
    return {0.0, double(v), 0.0, 0.0};
}

constexpr inline quatd operator""_j(unsigned long long v)
{
    return {0.0, 0.0, double(v), 0.0};
}

constexpr inline quatd operator""_k(unsigned long long v)
{
    return {0.0, 0.0, 0.0, double(v)};
}
