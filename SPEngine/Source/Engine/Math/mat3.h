...
#ifndef SP_MATH_MAT3_H
#define SP_MATH_MAT3_H
...
public:
     ...
     */
    static constexpr TMat33 getTransformForNormals(const TMat33& m) noexcept { return matrix::cof(m); }
...
constexpr TMat33<T>::TMat33() noexcept
    : m_value{col_type(1, 0, 0), col_type(0, 1, 0), col_type(0, 0, 1)}
{}

template <typename T>
template <typename U>
constexpr TMat33<T>::TMat33(U v) noexcept
    : m_value{col_type(v, 0, 0), col_type(0, v, 0), col_type(0, 0, v)}
{}

template <typename T>
template <typename U>
constexpr TMat33<T>::TMat33(const TVec3<U>& v) noexcept
    : m_value{col_type(v[0], 0, 0), col_type(0, v[1], 0), col_type(0, 0, v[2])}
{}
...
{
    return m * details::TMat33<T>(1.0 / std::sqrt(max(details::TVec3<float>{length2(m[0]), length2(m[1]), length2(m[2])})));
}
...
namespace std {
template <typename T>
constexpr void swap(SP::math::details::TMat33<T>& lhs, SP::math::details::TMat33<T>& rhs) noexcept
{
