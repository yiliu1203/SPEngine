...
#ifndef SP_MATH_VEC3_H
#define SP_MATH_VEC3_H
...
public:
    ...
    template <typename U>
    friend inline constexpr TVec3<arithmetic_result_t<T, U>> cross(const TVec3& u, const TVec3<U>& v) noexcept
    {
