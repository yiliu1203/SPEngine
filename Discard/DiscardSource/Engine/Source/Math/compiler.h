...
#ifndef SP_MATH_COMPILER_H
#define SP_MATH_COMPILER_H
...
#    define CONSTEXPR_IF_NOT_MSVC \
        constexpr   // when declared constexpr, msvc fails with "failure was caused by cast of object of dynamic type"
